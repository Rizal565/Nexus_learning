                        ...
                        <div class="card-body">
                            <form action="" method="post" class="form-horizontal" enctype="multipart/form-data">
                                <div class="form-group row">
                                    <label for="id_kategori" class="col-sm-2 col-form-label col-form-label-sm">Kategori</label>
                                    <div class="col-sm-10">
                                        <select name="id_kategori" id="id_kategori" class="form-control form-control-sm" required>
                                            <option value="">--- Pilih Kategori ---</option>
                                            <?php foreach ($kategori as $row) : ?>
                                                <option value="<?= $row->id_kategori ?>" <?= $row->id_kategori === $materi->id_kategori ? 'selected' : '' ?>><?= $row->nama_kategori ?></option>
                                            <?php endforeach; ?>
                                        </select>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="judul_materi" class="form-control form-control-sm" name="judul_materi" id="judul_materi" autocomplete="off" value="<?= set_value('judul_materi', $materi->judul_materi) ?>" required>
