...
class AdminController extends CI_Controller
{
    ...
    public function index()
    {
        $data = [
            'title' => 'Data Admin',
            'result' => $this->AdminModel->getData()
        ];

        $this->load->view('layout/head', $data);
        $this->load->view('layout/navbar', $data);
        $this->load->view('dashboard/data_admin/index', $data);
    ...
    public function create()
    {
        ...
        if ($this->form_validation->run() == false) {
            ...
            $this->load->view('layout/head', $data);
            $this->load->view('layout/navbar', $data);
            $this->load->view('dashboard/data_admin/create', $data);
            $this->load->view('layout/footer', $data);
            $this->load->view('layout/javascript', $data);
        } else {
            // Upload gambar
            ...
            $data = array(
                ...
                'role' => 'administrator', // You can set the role as per your requirements
            );
    ...
    public function edit($id)
    {
        $data = [
            'title' => 'Data Admin',
            'user' => $this->AdminModel->getData($id),
        ];
        ...
        if ($this->form_validation->run() == false) {
            $this->load->view('layout/head', $data);
            $this->load->view('layout/navbar', $data);
            $this->load->view('dashboard/data_admin/edit', $data);
            $this->load->view('layout/footer', $data);
            $this->load->view('layout/javascript', $data);
        } else {
            ...
            $this->AdminModel->updateData($id, $update_data);
